---
name: prd
description: Run a 2-step workflow: (1) PRD with 3–5 clarifying questions, saved to /tasks/<feature-name>-prd.md; (2) task list in two phases (parent tasks then subtasks after “Go”), saved to /tasks/<feature-name>-tasks.md.
...
Step 2: Generate tasks in /tasks/<feature-name>-tasks.md 
